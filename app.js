...
1. A player looses his entire score when he rolls two six in a row. After that, it's the next player's
...
3. Add another dice to the game, so that there are two dices now. The player looses his current score
   when one of them is a 1. (Hint: you wil need CSS to position the second dice, so take a look at the CSS
